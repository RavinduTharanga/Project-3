...
int main(){
	...
	// now make a new "blank" list
	listPtr2 = new ItemList();

	// and then use the assignment operator to populate data members in list2
	*listPtr2 = *listPtr;

	// and show the copied list
	cout << endl;
	cout << "Our copy of the inventory is: ";
	listPtr2->showInventory();
